...
function App() {
  ...
  this.selectDate = ({ target }) => {
    ...
    console.log((0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.getDateString)(this.state.selectedDate));
  };
